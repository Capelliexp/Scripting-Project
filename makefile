...
main: project/main.cpp project/luaFunctions.cpp project/globals.h project/lua/src/liblua.a project/irrlicht/lib/Linux/libIrrlicht.a project/CSampleSceneNode.cpp
